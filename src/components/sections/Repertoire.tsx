    ...
    <section id="repertoire" className="relative min-h-screen w-full bg-transparent py-24 flex flex-col justify-center">
      ...
      <div className="container mx-auto px-6 md:px-16 lg:px-20 relative z-10 w-full max-w-6xl">
        ...
        <div className="mb-20 text-center">
          ...
          <h2 className="text-bright-cream font-cinzel text-3xl md:text-5xl tracking-[0.3em] font-bold mb-4 uppercase">
            REPERTOIRE
          </h2>
          <p className="text-cream/50 font-julee italic">
            The instruments I play to create digital harmony.
          </p>
        </div>
        ...
        >
          ...
          <motion.div className="md:col-span-5 h-full" variants={cardVariants}>
            <GlassCard className="h-full p-8 hover:border-saffron/40 hover:shadow-[0_0_25px_rgba(244,162,97,0.1)] transition-all duration-500 flex flex-col justify-between relative overflow-hidden group min-h-[450px]">
              ...
              <span className="absolute right-6 bottom-4 font-cinzel text-9xl font-black text-white/[0.02] group-hover:text-saffron/[0.04] select-none pointer-events-none transition-colors duration-500">
                {movement1.roman}
              </span>
              
              <div>
                <span className="font-lexend text-[10px] tracking-[0.25em] text-saffron font-bold block mb-2">
                  MOVEMENT I
                </span>
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-3 bg-white/5 rounded-xl border border-white/10 group-hover:border-saffron/30 transition-colors">
                    {movement1.icon}
                  </div>
                  <div>
                    <h3 className="text-bright-cream font-cinzel text-xl font-bold tracking-wide">
                      {movement1.title}
                    </h3>
                    <span className="text-[10px] tracking-[0.15em] text-cream/40 uppercase block mt-0.5">
                      {movement1.subtitle}
                    </span>
                  </div>
                </div>
          ...
          <div className="md:col-span-7 flex flex-col gap-8 justify-between">
            ...
            <motion.div variants={cardVariants} className="h-full">
              <GlassCard className="h-full p-8 hover:border-saffron/40 hover:shadow-[0_0_25px_rgba(244,162,97,0.1)] transition-all duration-500 flex flex-col justify-between relative overflow-hidden group min-h-[210px]">
                <span className="absolute right-6 bottom-2 font-cinzel text-9xl font-black text-white/[0.02] group-hover:text-saffron/[0.04] select-none pointer-events-none transition-colors duration-500">
                  {movement2.roman}
                </span>
