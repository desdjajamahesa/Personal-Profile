...
const GlassCard = ({ children, className }: GlassCardProps) => {
  return (
    <motion.div
      ...
      whileHover={{ 
        y: -8, 
        borderColor: "rgba(255, 255, 255, 0.4)", // Border jadi lebih putih cerah
        boxShadow: "0 0 30px 5px rgba(255, 253, 240, 0.15)" // Pendaran putih di area luar card
      }}
      transition={{ 
        duration: 0.8, 
        ease: "easeOut",
      ...
      className={`
        ...
        border-2 border-cream/60 rounded-[2rem]
